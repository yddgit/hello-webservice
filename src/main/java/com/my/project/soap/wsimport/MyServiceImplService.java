 ...
 * 
 */
@WebServiceClient(name = "MyServiceImplService", targetNamespace = "http://project.my.com/webservice", wsdlLocation = "http://localhost:9000/myService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName MYSERVICEIMPLSERVICE_QNAME = new QName("http://project.my.com/webservice", "MyServiceImplService");
    ...
    public IMyService getMyServiceImplPort() {
        return super.getPort(new QName("http://project.my.com/webservice", "MyServiceImplPort"), IMyService.class);
    }
    ...
    public IMyService getMyServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://project.my.com/webservice", "MyServiceImplPort"), IMyService.class, features);
    }
