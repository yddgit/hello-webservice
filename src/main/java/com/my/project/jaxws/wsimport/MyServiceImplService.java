 ...
 * 
 */
@WebServiceClient(name = "MyServiceImplService", targetNamespace = "http://jaxws.project.my.com/", wsdlLocation = "http://localhost:9000/myService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName MYSERVICEIMPLSERVICE_QNAME = new QName("http://jaxws.project.my.com/", "MyServiceImplService");
    ...
    public IMyService getMyServiceImplPort() {
        return super.getPort(new QName("http://jaxws.project.my.com/", "MyServiceImplPort"), IMyService.class);
    }
    ...
    public IMyService getMyServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://jaxws.project.my.com/", "MyServiceImplPort"), IMyService.class, features);
    }
